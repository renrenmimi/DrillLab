...
const PAGES: Hit[] = [
  ...
  },
  {
    ...
    haystack: "八股 题库 抽认卡 drill flashcard 面试 interview",
  },
  {
    href: "/code",
    kind: L("页面", "Page"),
    ...
    haystack: "coding 题 沙箱 sandbox 浏览器 run 跑测试",
  },
  {
    href: "/arena",
    kind: L("页面", "Page"),
    ...
    haystack: "考场 arena 从零重写 计时 timed 验收",
  },
  {
    href: "/practice",
    kind: L("页面", "Page"),
    title: L("练习", "Practice"),
    sub: L("按考试 / 难度 / 类型筛练习", "Filter by course, difficulty and kind"),
    haystack: "练习 练习场 填空 debug 难度 practice exercise",
  },
  {
    href: "/mock",
    kind: L("页面", "Page"),
